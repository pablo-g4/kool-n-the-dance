    ...
    return (
        <>
            <nav className="navbar navbar-expand-lg navbar-light">
                <Link to="/" className="navbar-brand"> KOOL 'N' THE DANCE </Link>
                ...
                <div className='navicon navbar-collapse collapse navbar-collapse text-center' id="navbarSupportedContent">
                    <a href='https://www.facebook.com/people/Kool-N-the-dance/100063903799414/' target='_blank'> <SocialIcon network="facebook" bgColor="#FFFFFF" style={{ height: 30, width: 30, marginTop: "4%" }} /></a>
                </div>
            </nav>
        </>
    )
